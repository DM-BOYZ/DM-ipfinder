...
def ipinfo():
    ...
    print (" ")
       ...
       slowprint("\033[1;36m" + " Region      : \033[1;36m " + values['regionName'])
       slowprint("\033[1;36m" + " Country     : \033[1;33m " + values['country'])
       ...
       print (" ")
       slowprint("\033[1;32m =====================================")
       slowprint("\033[1;33m|        Coded By DM-BOYZ            |")
       slowprint("\033[1;31m =====================================")
...
def ext():
      slowprint ("\033[1;32m ==============================================")
      slowprint ("\033[1;31m|      Thanks For Using DM-ipfinder           |")
      slowprint ("\033[1;32m ==============================================")
      time.sleep(1)
      exit()
